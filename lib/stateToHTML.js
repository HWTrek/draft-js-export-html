...
var ENTITY_ATTR_MAP = (_ENTITY_ATTR_MAP = {}, _defineProperty(_ENTITY_ATTR_MAP, _draftJsUtils.ENTITY_TYPE.LINK, { href: 'href', rel: 'rel', title: 'title', className: 'class' }), _defineProperty(_ENTITY_ATTR_MAP, _draftJsUtils.ENTITY_TYPE.IMAGE, { src: 'src', height: 'height', width: 'width', alt: 'alt', className: 'class' }), _ENTITY_ATTR_MAP);
  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function renderBlockContent(block) {
      ...
      return entityPieces.map(function (_ref) {
        ...
        var _options$entityRender = _this.options.entityRenderers;
        var entityRenderers = _options$entityRender === undefined ? {} : _options$entityRender;
        ...
        if (entityType != null && entityType === _draftJsUtils.ENTITY_TYPE.LINK) {
          ...
          var html = entityRenderers.hasOwnProperty(entityType) ? entityRenderers[entityType](entityType, entity) : null;
